...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.ResumeViewHolder> {
    ...
    public ProfileAdapter(String[] sections, int[] sectionIcons, int[] progress) {
